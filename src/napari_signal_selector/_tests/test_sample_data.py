from napari_signal_selector._sample_data import (load_blinking_polygons_data,
...
def test_open_sample_data():
    ...
    # Check that example labels features (table) shape is correct
    assert layer_data_tuple[1][1]["features"].shape == (
        15000,
        4,
    )  # blinking polygons has annotations

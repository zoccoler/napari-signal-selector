...
class InteractiveLine2D(Line2D):
    ...
    def __init__(self, *args, axes=None, canvas=None, label_from_napari_layer, color_from_napari_layer,
        ...
        self.cmap = make_cat10_mod_cmap()
        self.normalizer = Normalize(vmin=0, vmax=self.cmap.N - 1)
...
class InteractiveFeaturesLineWidget(FeaturesLineWidget):
    ...
    def __init__(
        ...
        ### ColorSpinBox ###
        self.signal_class_color_spinbox = QtColorSpinBox(first_color_transparent=True)
